...
namespace AspStudio_Boilerplate.Views.Shared.TagHelpers
{
    /// <summary>
    ...
    public class AnchorTagHelperSubArea : TagHelper
    {
        ...
        public AnchorTagHelperSubArea(IHtmlGenerator generator)
        {
            Generator = generator;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if ((routeLink && actionLink) || (routeLink && pageLink) || (actionLink && pageLink))
            {
                var message = string.Join(
                    Environment.NewLine,
                    "Cannot determine attribute for href",
                    RouteAttributeName,
